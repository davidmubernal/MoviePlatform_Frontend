...
export function Film({_id, title, director, year, score, image, onEdit, onDelete}) {
  ...
  return (
    <div className='film' onClick={updateFilm} id={_id}>
      ...
      {/* <img className='preview' loading='lazy' src={preview}></img> */} 
...
export function Star({fill=false}) {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
      <path className="" fill={fill ? 'yellow' : ''} stroke="black" d="M12,17.3l6.2,3.7l-1.6-7L22,9.2l-7.2-0.6L12,2L9.2,8.6L2,9.2L7.5,14l-1.6,7L12,17.3z"></path>
    </svg>
  )
}